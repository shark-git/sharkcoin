...
QT_TRANSLATE_NOOP("quark-core", "Sharkcoin version"),
...
QT_TRANSLATE_NOOP("quark-core", "Error loading wallet.dat: Wallet requires newer version of Sharkcoin"),
...
QT_TRANSLATE_NOOP("quark-core", "SSL options: (see the Sharkcoin Wiki for SSL setup instructions)"),
...
QT_TRANSLATE_NOOP("quark-core", "Specify configuration file (default: sharkcoin.conf)"),
...
QT_TRANSLATE_NOOP("quark-core", "Specify pid file (default: sharkcoind.pid)"),
...
QT_TRANSLATE_NOOP("quark-core", "Wallet needed to be rewritten: restart Sharkcoin to complete"),
