...
// Copyright (c) 2014 The Quark developers
// Copyright (c) 2014 The Sharkcoin developers http://www.sharkcoin.org
...
uint256 hashGenesisBlock("0x000000042864103f8cd5cb2c644e71bdc109e80249fae4ec5d0e384c884ff2dd");
static const unsigned int timeGenesisBlock = 1398300393;
...
static const int64 nTargetTimespan = 80 * 60; // 80 minutes
static const int64 nTargetSpacing = 20; // 20 seconds
static const int64 nInterval = nTargetTimespan / nTargetSpacing; // 240 blocks
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xcb6834a4ab78d4fd4fc550a38f9e376738cfe850e18c24ce402e872f552c21d4"));
...
unsigned char pchMessageStart[4] = { 0xfe, 0xa5, 0x03, 0xdb };
