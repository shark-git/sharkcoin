...
{    
    ...
    static MapCheckpoints mapCheckpoints =
	    ...
	    ( 2902230,     uint256("0x0000000001f6d4f5f49adfc84fe406e83ac7dbab06ae15741f48f9540afe4620"))
        ;
    static const CCheckpointData data = {
        &mapCheckpoints,
        1456924382, // * UNIX timestamp of last checkpoint block
        3167626,    // * total number of transactions between genesis and last checkpoint
